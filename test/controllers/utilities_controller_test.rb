...
class UtilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utility" do
    assert_difference("Utility.count") do
      post utilities_url, params: { utility: { description: @utility.description, kiosk_id: @utility.kiosk_id, name: @utility.name } }
    end
  ...
  test "should update utility" do
    patch utility_url(@utility), params: { utility: { description: @utility.description, kiosk_id: @utility.kiosk_id, name: @utility.name } }
